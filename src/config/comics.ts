export const comicsConfig = [
  {
    ...
    comics: [
      "/comics-1/pages/Page1.svg",
      "/comics-1/pages/Page2.svg",
      "/comics-1/pages/Page3.svg",
      "/comics-1/pages/Page4.svg",
      "/comics-1/pages/Page5.svg",
      "/comics-1/pages/Page6.svg",
    ],
    description:
      'Dive into the thrilling world of CAR-T therapy with "The Rise of Captain CAR." Follow the journey of brave heroes battling cancer at the cellular level, showcasing the power of cutting-edge science and teamwork.',
    characterFiles: [
